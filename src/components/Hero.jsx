...
import heroVideo from '../assets/hero video/asir-hero.mp4';
...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      {/* Content Container */}
      <div className="absolute inset-0 z-20 px-2 pb-20 md:pb-[8%] md:px-4 lg:px-6 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <h1 className="text-white text-3xl md:text-5xl font-bold mb-4 tracking-tight">
            <span className="block">{heroContent.greeting},</span>
            <span className="mt-2 md:mt-3 block bg-gradient-to-r from-orange-200 via-yellow-300 to-amber-400 bg-clip-text text-transparent">
          ...
          >
            ...
            <a 
              ...
              className="px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-black/40 border border-white/70 text-white font-semibold transition-all duration-300 backdrop-blur-md hover:bg-white hover:text-black hover:border-white hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:scale-[1.03]"
            >
            ...
            <a 
              ...
              download
              className="px-3 py-1.5 md:px-4 md:py-2 text-[11px] md:text-sm rounded-full bg-transparent border border-white/50 text-white font-semibold transition-all duration-300 backdrop-blur-md flex items-center gap-2 hover:bg-white hover:text-black hover:border-white hover:shadow-[0_0_20px_rgba(255,255,255,0.15)] hover:scale-[1.03]"
            >
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="relative w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-white/10 backdrop-blur-xl flex justify-center items-center transition-all duration-500 shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_12px_40px_rgba(0,0,0,0.35)] group-hover:scale-110 group-hover:border-white/60 group-hover:bg-white/20 group-hover:shadow-[0_0_0_1px_rgba(255,255,255,0.2),0_18px_50px_rgba(255,255,255,0.16)]">
            <div className="absolute inset-0 rounded-full border border-white/10" />
            {!isPlaying || isMuted ? (
              // Play Icon
              <svg className="relative z-10 w-5 h-5 md:w-8 md:h-8 text-white ml-0.5 md:ml-1" fill="currentColor" viewBox="0 0 24 24">
                <path d="M8 5v14l11-7z" />
              </svg>
            ) : (
              // Pause Icon
              <svg className="relative z-10 w-5 h-5 md:w-8 md:h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
